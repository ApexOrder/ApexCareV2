      ...
      <div className="py-10">
        <header>
          <div className="mx-auto max-w-[100rem] px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            <h1 className="text-3xl font-black leading-tight tracking-tight text-slate-900">Group Management</h1>
            <button
        ...
        <main>
          <div className="mx-auto max-w-[100rem] sm:px-6 lg:px-8">
            <div className="px-4 py-8 sm:px-0">
              ...
              {showForm && (
                <div className="mb-8 bg-white border border-slate-200 shadow-sm rounded-[2.5rem] p-8 animate-in fade-in slide-in-from-top-4">
                  <h3 className="text-xl font-black leading-6 text-slate-900 mb-6">Create New Group</h3>
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <textarea name="description" id="description" rows={3}
                          ...
                          className="block w-full rounded-xl border-slate-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border p-3 font-medium text-slate-700" 
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {groups.map((group) => (
                  <div key={group.id} className="bg-white border border-slate-200 shadow-sm overflow-hidden rounded-[2.5rem] hover:shadow-md transition-all group relative">
                    <div className="px-8 py-8">
                      <div className="flex justify-between items-start mb-4">
                         ...
                         }} className="text-slate-300 hover:text-rose-500 transition-colors">🗑️</button>
                      </div>
                      ...
                      <div className="flex items-center gap-4 pt-6 border-t border-slate-100">
                          <div>
                              ...
                              <p className="text-lg font-black text-slate-900">{group.staffCount}</p>
                          </div>
                          <div className="w-px h-8 bg-slate-100"></div>
                          <div>
                              <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Patients</p>
                              <p className="text-lg font-black text-slate-900">{group.patientCount}</p>
                          </div>
                      </div>
                    </div>
                  </div>

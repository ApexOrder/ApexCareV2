  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="py-10">
        <header>
          <div className="mx-auto max-w-[100rem] px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-black leading-tight tracking-tight text-slate-900">Agency Profile</h1>
          </div>
        </header>
        <main>
          <div className="mx-auto max-w-[100rem] sm:px-6 lg:px-8">
            <div className="px-4 py-8 sm:px-0">
              <div className="bg-white border border-slate-200 shadow-sm overflow-hidden rounded-[2.5rem]">
                <div className="px-8 py-8 border-b border-slate-200 bg-slate-50/50">
                  <h3 className="text-xl font-black leading-6 text-slate-900">Agency Information</h3>
                  <p className="mt-1 max-w-2xl text-sm font-bold text-slate-500">Details and subscription status.</p>
                </div>
                <div className="border-t border-slate-200">
                  <dl>
                    <div className="bg-slate-50 px-8 py-6 sm:grid sm:grid-cols-3 sm:gap-4">
                      <dt className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Agency name</dt>
                      <dd className="mt-1 text-sm font-bold text-slate-900 sm:mt-0 sm:col-span-2">Apex Home Health</dd>
                    </div>
                    <div className="bg-white px-8 py-6 sm:grid sm:grid-cols-3 sm:gap-4">
                      <dt className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Subscription Plan</dt>
                      <dd className="mt-1 text-sm font-bold text-slate-900 sm:mt-0 sm:col-span-2">Professional Tier</dd>
                    </div>
                    <div className="bg-slate-50 px-8 py-6 sm:grid sm:grid-cols-3 sm:gap-4">
                      <dt className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Email address</dt>
                      <dd className="mt-1 text-sm font-bold text-slate-900 sm:mt-0 sm:col-span-2">admin@apexcare.com</dd>
                    </div>
                    <div className="bg-white px-8 py-6 sm:grid sm:grid-cols-3 sm:gap-4">
                    ...
                    <div className="bg-slate-50 px-8 py-6 sm:grid sm:grid-cols-3 sm:gap-4">
                      ...
                      <dd className="mt-1 text-sm font-bold text-slate-900 sm:mt-0 sm:col-span-2">April 1, 2024</dd>
                    </div>
                  </dl>
                </div>
              </div>
